...
<div class="container mt-4">
    ...
    <div class="card p-4">
        ...
        {{-- BUKA FORM DI SINI --}}
        <form action="{{ route('pengunjung.pendaftaran.store') }}" method="POST">
            @csrf
            
            {{-- HIDDEN INPUT UNTUK ID EVENT --}}
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah_tiket" value="1" min="1" class="form-control">
            </div>
