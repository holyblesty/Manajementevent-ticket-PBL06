...
<footer class="mt-12 bg-[#24112e] rounded-3xl p-10 text-white shadow-xl">
    <div class="flex flex-col md:flex-row items-start justify-between">
        ...
        <div class="md:w-[30%] pr-8">
            <div class="flex items-center gap-4 mb-4">
                <img src="{{ asset('images/footer.jpg') }}" class="h-40 w-auto object-cover rounded-lg">
                <div class="flex-grow">
        ...
        <div class="md:w-[20%] md:border-l md:border-white/20 md:pl-8 py-2">
            <h4 class="text-white font-bold text-xs mb-4 uppercase tracking-widest">NAVIGASI</h4>
            <ul class="text-[11px] space-y-2 text-gray-400 font-medium">
                ...
                <li><a href="#" class="hover:text-[#be93d4] transition no-underline">Kontak Kami</a></li>
            </ul>
        </div>

        <div class="md:w-[20%] md:border-l md:border-white/20 md:pl-8 py-2">
            <h4 class="text-white font-bold text-xs mb-4 uppercase tracking-widest">KATEGORI</h4>
            <ul class="text-[11px] space-y-2 text-gray-400 font-medium">
        ...
        <div class="md:w-[30%] md:border-l md:border-white/20 md:pl-8 py-2">
            <h4 class="text-white font-bold text-xs mb-4 uppercase tracking-widest flex items-center gap-2">
                <span class="text-[#be93d4]"></span> HUBUNGI KAMI
            </h4>
    ...
    <div class="border-t border-white/20 mt-10 pt-4 text-center">
