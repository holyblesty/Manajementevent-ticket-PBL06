                ...
                <tr class="hover:bg-gray-50/50 transition duration-300">
                    ...
                    <td class="px-6 py-5 text-center">
                        <div class="inline-flex items-center justify-center bg-gray-100 px-5 py-3 rounded-md border border-gray-200">
                            <svg class="w-5 h-5 text-gray-500 mr-2" fill="currentColor" viewBox="0 0 20 20"><path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" /></svg>
                    ...
                    <td class="px-6 py-5">
                        <div class="flex justify-center items-center gap-3"> 
                            <a href="{{ route('admin.acara.tiket', $event->id) }}" class="no-underline" style="width: 90px; height: 42px; background-color: #be93d4; color: #24112e; border-radius: 8px; font-size: 13px; font-weight: 900; display: flex; align-items: center; justify-content: center; text-transform: uppercase; letter-spacing: 0.05em;">TIKET</a>
                            <a href="{{ route('admin.acara.edit', $event->id) }}" class="no-underline" style="width: 90px; height: 42px; background-color: #24112e; color: white; border-radius: 8px; font-size: 13px; font-weight: 900; display: flex; align-items: center; justify-content: center; text-transform: uppercase; letter-spacing: 0.05em;">UBAH</a>
